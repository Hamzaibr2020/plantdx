...
// Türkiye'nin 81 ili - gerçek il merkezi koordinatları
export const TURKEY_PROVINCES: Province[] = [
  ...
  { name: "Bolu", lat: 40.735, lon: 31.6061 },
  ...
  { name: "Elazığ", lat: 38.6748, lon: 39.2226 },
  ...
  { name: "Osmaniye", lat: 37.075, lon: 36.2478 },
  { name: "Düzce", lat: 40.8438, lon: 31.1565 },
];

export const CROPS = [
  "Domates", "Biber", "Salatalık", "Patlıcan", "Buğday", "Arpa", "Mısır",
  "Ayçiçeği", "Pamuk", "Şeker Pancarı", "Üzüm", "Elma", "Zeytin", "Fındık",
  "Fıstık", "Çay", "Tütün", "Patates",
];
